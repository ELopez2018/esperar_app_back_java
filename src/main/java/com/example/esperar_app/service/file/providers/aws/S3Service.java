package com.example.esperar_app.service.file.providers.aws;
    ...
    public void uploadUserDocument(
        ...
        switch (imageType) {
            case CHAMBER_OF_COMMERCE:
                ...
                user.setChamberOfCommerceUrl("https://s3.amazonaws.com/esperar-app/" + file.getOriginalFilename());
                break;
            case DRIVER_LICENSE:
                updateEntityDocumentFields(
